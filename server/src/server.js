...
var convert_hour_string_to_minute_1 = require("./utils/convert-hour-string-to-minute");
var convert_minutes_to_hour_string_1 = require("./utils/convert-minutes-to-hour-string");
...
app.get('/games', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                games = _a.sent();
                return [2 /*return*/, response.status(200).json(games)];
        }
    });
}); });
            ...
            case 0:
                ...
                return [4 /*yield*/, prisma.ad.create({
                        data: {
                            ...
                            hourStart: (0, convert_hour_string_to_minute_1.convertHourStringToMinutes)(body.hourStart),
                            hourEnd: (0, convert_hour_string_to_minute_1.convertHourStringToMinutes)(body.hourEnd),
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, response.json(ads.map(function (ad) {
                        return __assign(__assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, convert_minutes_to_hour_string_1.convertMinutesToHourString)(ad.hourStart), hourEnd: (0, convert_minutes_to_hour_string_1.convertMinutesToHourString)(ad.hourEnd) });
                    }))];
        }
    });
}); });
